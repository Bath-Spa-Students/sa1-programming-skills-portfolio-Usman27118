...
country = input("what is capital of france:")
if country == "Paris":
...
country = input("what is capital of Italy:")
if country == "Rome":
    print("answer is correct")
else:
    print("answer is wrong")

country = input("what is capital of Denmark:")
if country == "Copenhagen":
    print("answer is correct")
else:
    print("answer is wrong")

country = input("what is capital of Finland:")
if country == "Helsinki":
    print("answer is correct")
else:
    print("answer is wrong")

country = input("what is capital of Norway:")
if country == "Oslo":
    print("answer is correct")
else:
    print("answer is wrong")

country = input("what is capital of Spain:")
if country == "Madrid":
    print("answer is correct")
else:
    print("answer is wrong")

country = input("what is capital of United Kingdom:")
if country == "London":
    print("answer is correct")
else:
    print("answer is wrong")

country = input("what is capital of Sweden:")
if country == "Stockholm":
    print("answer is correct")
else:
    print("answer is wrong")

country = input("what is capital of Ireland:")
if country == "Dublin":
    print("answer is correct")
else:
    print("answer is wrong")

country = input("what is capital of Portugal:")
if country == "Lisbon":
    print("answer is correct")
else:
    print("answer is wrong")

country = input("what is capital of Switzerland:")
if country == "Bern":
    print("answer is correct")
else:
    print("answer is wrong")
